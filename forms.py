...
class Register(Form):
    ...
    email = StringField('Email Address', [validators.DataRequired(),validators.Email(), validators.Regexp(re.compile('^.+@[^.].*\.[a-z]{2,10}$'), message="Invalid email address.")],render_kw={"placeholder": "E.g you@example.com"})
    password = PasswordField('New Password', [
        validators.DataRequired(),
